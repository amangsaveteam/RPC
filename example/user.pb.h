...
class ResultCode : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Kuser.ResultCode) */ {
 public:
  ResultCode();
  virtual ~ResultCode();
...
class LoginRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Kuser.LoginRequest) */ {
 public:
  LoginRequest();
...
class LoginResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Kuser.LoginResponse) */ {
 public:
  LoginResponse();
...
class RegisterRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Kuser.RegisterRequest) */ {
 public:
  RegisterRequest();
...
class RegisterResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Kuser.RegisterResponse) */ {
 public:
  RegisterResponse();
...
inline const ::Kuser::ResultCode& LoginResponse::result() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::Kuser::ResultCode*>(
...
inline ::Kuser::ResultCode* LoginResponse::mutable_result() {
  ...
  if (result_ == NULL) {
    auto* p = CreateMaybeMessage<::Kuser::ResultCode>(GetArenaNoVirtual());
    result_ = p;
  }
